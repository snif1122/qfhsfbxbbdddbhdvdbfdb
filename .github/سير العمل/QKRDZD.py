...
def send(X):
				...
				requests.get(f'https://api.telegram.org/bot{Token}/sendMessage?chat_id={ID}&text=لا تـنسى ان تـرسل صـور الـصيد - @enlinge_bot 🏆&reply_to_message_id={idmesg}')
...
DATA ==> {date}
 REST ==> {rest}
privet ==> {privet}
LANK ==> »https://www.instagram.com/{user}
...
88' Y8b .8P  Y8.    `8P' .8P  Y8. 
88      88    88     88  88    88 
88  ooo 88    88     88  88    88 
88. ~8~ `8b  d8' db. 88  `8b  d8' 
 Y888P   `Y88P'  Y8888P   `Y88P'  
